...
const routes = [
  {
    ...
    camps: [
      ...
      { name: 'Camp 2', alt: 5700, lat: 28.6250, lon: 83.8168, blurb: 'Where the face steepens. Most teams cross the slopes above before dawn, when the ice is frozen.' },
      { name: 'Camp 3', alt: 6400, lat: 28.6126, lon: 83.8183, blurb: 'A snow shelf beneath the serac barrier; the Sickle hangs directly overhead.' },
      { name: 'Camp 4', alt: 7050, lat: 28.6071, lon: 83.8190, blurb: 'On the Sickle Glacier itself, above the barrier. The 1950 summit party left from here, in canvas boots.' },
  ...
  },
  {
    ...
    color: '#ffc14d',
    firstAscent: '13 October 1977, a Dutch expedition, seeking a line out of the Sickle’s fall line',
    share: 'Used by most commercial teams since the 2010s',
    difficulty: 'A rock and ice rib at 45-55° to about 6,500 m, then the French route’s upper slopes',
    verticalGain: '≈ 3,900 m from Base Camp',
    summary:
      'A rib to the left of the 1950 line that keeps climbers out from under the worst of the serac until they reach the Sickle. Safer, but steeper and still exposed to the slopes above; the 1978 American women’s expedition lost two climbers here.',
    waypoints: [
      [28.6400, 83.8100], // Base Camp
      [28.6373, 83.8153],
      [28.6318, 83.8160], // C1
    ...
    camps: [
      { name: 'Camp 2', alt: 5700, lat: 28.6200, lon: 83.8125, blurb: 'At the foot of the rib, west of the main avalanche funnel.' },
      { name: 'Camp 3', alt: 6550, lat: 28.6060, lon: 83.8140, blurb: 'Perched on the crest of the rib, the hardest climbing of the route below it.' },
      { name: 'Camp 4', alt: 7200, lat: 28.6030, lon: 83.8170, blurb: 'Where the rib meets the Sickle Glacier and the slope eases.' },
    ],
  ...
  },
  {
    ...
    camps: [
      ...
      { name: 'Camp 2', alt: 5500, lat: 28.5774, lon: 83.8368, blurb: 'Below the ice ridge, in the path of serac fall from the whole face.' },
      ...
      { name: 'Camp 5', alt: 7050, lat: 28.5895, lon: 83.8245, blurb: 'At the foot of the rock band, the crux of the face.' },
  ...
  },
  {
    ...
    verticalGain: '≈ 2,100 m from the Roc Noir col',
    summary:
      'The long way: from the Sanctuary side over Glacier Dome and Roc Noir, then west along the ridge over the East and Central summits, a traverse Loretan and Joos completed in a single alpine push and descended by the north face. Jean-Christophe Lafaille finally reached the summit this way in 2002, ten years after the face that nearly killed him.',
    waypoints: [
      [28.5990, 83.8700], // ridge start
      [28.5983, 83.8576], // C1
      [28.5975, 83.8452],
      [28.5971, 83.8369], // Roc Noir
      [28.5967, 83.8300], // Annapurna East
      [28.5963, 83.8244], // Annapurna Central
      [28.5961, 83.8203], // Summit
    ],
    camps: [
      { name: 'Camp 1', alt: 6050, lat: 28.5983, lon: 83.8576, blurb: 'On the ridge east of Roc Noir, reached from the Sanctuary over Glacier Dome.' },
      { name: 'Roc Noir', alt: 7200, lat: 28.5971, lon: 83.8369, blurb: 'The black rock tower on the ridge, the last bivouac before the summits.' },
      { name: 'Annapurna East', alt: 8026, lat: 28.5967, lon: 83.8300, blurb: 'The first of three 8,000 m tops on the ridge; from here it is two hours of cornices to the main summit.' },
      { name: 'Annapurna Central', alt: 8051, lat: 28.5963, lon: 83.8244, blurb: 'The middle summit, a snow dome on the crest.' },
    ],
...
const hazards = [
  {
    id: 'sickle', name: 'The Sickle', lat: 28.6098, lon: 83.8186, alt: 6800, radius: 380, severity: 5,
  ...
  {
    id: 'east-ridge', name: 'The long ridge', lat: 28.5975, lon: 83.8452, alt: 6600, radius: 420, severity: 4,
...
const timeline = [
  ...
  { year: 1977, title: 'The Dutch Rib', text: 'A Dutch team opens a rib on the north face that avoids the worst of the Sickle. It becomes the modern normal route.' },
